...
public class TeacherDashboardPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        pnlQuick.add(UIHelper.createStandardButton("ĐIỂM DANH NHANH", UIHelper.SUCCESS_COLOR, "\u2705"),
                "grow, height 50");
        pnlQuick.add(UIHelper.createStandardButton("NHẬP ĐIỂM NGAY", UIHelper.PRIMARY_COLOR, "\u270E"),
                "grow, height 50");
        pnlQuick.add(UIHelper.createStandardButton("XEM LỚP ĐÃ KẾT THÚC", UIHelper.ACCENT_COLOR, "\uD83D\uDCC1"),
                "grow, height 50");
        ...
        pnlChart1.add(
                new DashboardChart("TỶ LỆ CHUYÊN CẦN", Arrays.asList(80, 85, 90, 88, 92, 95), UIHelper.SUCCESS_COLOR),
                BorderLayout.CENTER);
        ...
        pnlChart2.add(new DashboardChart("BIẾN ĐỘNG ĐIỂM TRUNG BÌNH", Arrays.asList(6, 7, 8, 7, 9, 8),
                UIHelper.PRIMARY_COLOR), BorderLayout.CENTER);
